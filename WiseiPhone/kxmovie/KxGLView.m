...
NSString *const vertexString = SHADER_STRING
(
...
NSString *const rgbFragmentString = SHADER_STRING
(
...
NSString *const yuvFragmentString = SHADER_STRING
(
 varying highp vec2 v_texcoord;
...
- (BOOL)loadShaders
{
    ...
    vertShader = compileShader(GL_VERTEX_SHADER, vertexString);
	if (!vertShader)
        goto exit;
