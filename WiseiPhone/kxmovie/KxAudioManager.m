...
- (BOOL) setupAudio
{
    ...
    NSLog(@"Current output bytes per sample: %lud", (unsigned long)_numBytesPerSample);
    NSLog(@"Current output num channels: %lud", (unsigned long)_numOutputChannels);
...
- (BOOL) checkSessionProperties
{
    ...
    NSLog(@"We've got %lud output channels", (unsigned long)newNumChannels);
