...
public class FeelVideoAct extends BaseAct implements OnClickListener {
   ...
   private Button mbtn =null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_feel_video);
        Intent in = getIntent();
         Bundle bun = in.getExtras();
         
        init_title(R.drawable.img_title_left, bun.getString("name"), R.drawable.img_titile_back);
        init();
